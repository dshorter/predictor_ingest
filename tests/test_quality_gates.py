"""Tests for extraction quality gates (Phase 1).
...
- run_quality_gates combined result

Note: evaluate_extraction, insert_quality_run/metric/evaluation, and the
quality_runs/quality_metrics DB tables were removed in ADR-008 (escalation
architecture replaced by Anthropic Batch API). Tests for those are removed.
"""
